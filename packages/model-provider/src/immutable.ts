...
export function validatePlainData(value: unknown): void {
  // Canonical serialization is the shared fail-closed JSON boundary. Besides
  // determinism it rejects functions, undefined, cycles, special objects, and
  // non-finite numbers before a fixture can influence a test run.
  canonicalize(value);
}
